...
SECRET_KEY = 'django-insecure-pwit=oi!m@q*ov9p^9$k2=!(zvh+(=dlgxc=)nx_)#swjg_5%!'
...
#}
DATABASES = {
    'default': dj_database_url.parse('postgres://qlenwspl:YJWXufhKa1FsN3pLSWu11gmNx82u2F8Q@horton.db.elephantsql.com/qlenwspl')
}
